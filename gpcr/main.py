...
if __name__ == "__main__":
    ...
    Data_set = Data_Encoder("../data/gpcr/train_gpcr.txt",'../data/gpcr/sdf_train/','../data/gpcr/sdf_train_id.txt',
    '../data/gpcr/pdb_train/','../data/gpcr/pdb_train_id.txt')
    training_set, dev_set = train_test_split(Data_set, test_size=0.2)
    test_set = Data_Encoder("../data/gpcr/test_gpcr.txt",'../data/gpcr/sdf_test/','../data/gpcr/sdf_test_id.txt',
    '../data/gpcr/pdb_test/','../data/gpcr/pdb_test_id.txt')
